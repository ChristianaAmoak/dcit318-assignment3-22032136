...
public class BankTransferProcessor : ITransactionProcessor
{
    ...
    {
        Console.WriteLine(
            $"Bank Transfer: Processed {transaction.Amount:C} for {transaction.Category}"
        );
    }
}
...
public class MobileMoneyProcessor : ITransactionProcessor
{
    ...
    {
        Console.WriteLine(
            $"Mobile Money: Processed {transaction.Amount:C} for {transaction.Category}"
        );
    }
}
...
public class CryptoWalletProcessor : ITransactionProcessor
{
    ...
    {
        Console.WriteLine(
            $"Crypto Wallet: Processed {transaction.Amount:C} for {transaction.Category}"
        );
    }
}
